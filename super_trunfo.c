...
int main() {
    ...
    printf("Densidade Populacional: Carta %d venceu (%d)\n", (densidade_populacional1 < densidade_populacional2) ? 1 : 2, densidade_populacional1 < densidade_populacional2); // Menor densidade vence
    printf("PIB per Capita: Carta %d venceu (%d)\n", (pib_percapta1 > pib_percapta2) ? 1 : 2, pib_percapta1 > pib_percapta2);
